...
use \Eshop\ShopBundle\Classes\FeedWriter\RSS1;
...
$newItem = $TestFeed->createNewItem();
$newItem->addElementArray(array('title'=>'The 2nd feed', 'link'=>'http://www.google.com', 'description'=>'This is a test of the Eshop\ShopBundle\Classes\FeedWriter class'));
$TestFeed->addItem($newItem);
