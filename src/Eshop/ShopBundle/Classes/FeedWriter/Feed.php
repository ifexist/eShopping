<?php
namespace Eshop\ShopBundle\Classes\FeedWriter;
 ...
 *
 * @package     UniversalEshop\ShopBundle\Classes\FeedWriter
...
abstract class Feed
{
    ...
    */
    ...
    /**
    * Collection of items as object of \Eshop\ShopBundle\Classes\FeedWriter\Item class.
    */
    private $items         = array();
    ...
    */
    public function addGenerator()
    {
        if ($this->version == Feed::ATOM)
            $this->setChannelElement('atom:generator', 'Eshop\ShopBundle\Classes\FeedWriter', array('uri' => 'https://github.com/mibe/Eshop\ShopBundle\Classes\FeedWriter'));
        else if ($this->version == Feed::RSS2)
            $this->setChannelElement('generator', 'Eshop\ShopBundle\Classes\FeedWriter');
        else
    ...
    * @link https://github.com/mibe/Eshop\ShopBundle\Classes\FeedWriter/issues/30
    *
    * @access   public
